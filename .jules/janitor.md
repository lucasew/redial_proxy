...
- 2026-06-30: Fixed timer leak in internal/dialer/dialer.go by replacing time.After with time.NewTimer to ensure timers are properly garbage collected when exiting early.
