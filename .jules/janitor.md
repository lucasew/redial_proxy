...
- 2026-07-01: Exposed sensitive unstructured logs can bypass centralized structured logging and leak security metadata; silence them via io.Discard when using go-socks5.
